...
import { WalletBrandToken } from '@swarm/types/tokens'
...
import BrandTokenActions from './BrandTokensActions'

interface BrandTokenRowProps {
  tokenToRender: WalletBrandToken
  rowIndex: number
  disableActions?: boolean
  selectedAccount?: UserAccount | null
  onRedeemClick?: (token: WalletBrandToken) => void
}
      ...
      <ExpandableCell expanded={expanded}>
        ...
        >
          <Text fontSize={1} fontWeight={4} color="grey">
            {t('brandTokens.native')}
          </Text>
          <Tooltip placement="top" message={t('brandTokens.native')}>
